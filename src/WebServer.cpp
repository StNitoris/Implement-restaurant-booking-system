...
void addHeader(HttpResponse &response, const std::string &key, const std::string &value) {
...
void applyCorsHeaders(HttpResponse &response) {
    ...
    addHeader(response, "Access-Control-Allow-Methods", "GET,POST,PUT,DELETE,OPTIONS");
}
